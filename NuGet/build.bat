...
"%MSBUILD_PATH%" "%SOURCE_DIR%\VirtoCommerce.BulkActionsModule.sln" /nologo /verbosity:m /t:Build /p:Configuration=Release;Platform="Any CPU"


nuget pack "%SOURCE_DIR%\VirtoCommerce.BulkActionsModule\VirtoCommerce.BulkActionsModule.Core\VirtoCommerce.BulkActionsModule.Core.csproj" -IncludeReferencedProjects -Symbols -Properties Configuration=Release -o "%TARGET_DIR%"
